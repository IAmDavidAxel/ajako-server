...
import com.example.ajakoserver.domain.user.User;
...
@Service
public class LocalUserServiceDetails implements UserDetailsService {
	...
	public LocalUser loadUserById(Long id) {
		User user = userService.findUserById(id).orElseThrow(() -> new ResourceNotFoundException("User"));
		return createLocalUser(user);
	}
